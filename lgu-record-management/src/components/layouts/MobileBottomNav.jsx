import { Home, Search, Plus, User, Menu, ScrollText } from "lucide-react";
import { useNavigate } from "react-router-dom";

export default function MobileBottomNav({ onAdd, onMenu, active, setActive, userRole }) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white  shadow-md lg:hidden">
      <div className="relative flex items-center justify-between px-6 h-16">
        ...
        <button
          onClick={onAdd}
          className="absolute -top-6 left-1/2 z-translate-x-1/2 bg-blue-500 hover:bg-blue-600 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg"
        >
